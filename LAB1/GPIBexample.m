...
% telling the waveform generator to put out a saw tooth at 2kHz and 2V
% amplitude

HP33120_SetSignal('SQU',2.0);
HP33120_SetFreq(4000);
...
title('Saw tooth at 2kHz and 4Vpp', 'fontsize',14);
grid on
