...
\begin{align}
    r_{ds} = \frac{\Delta V_{DS}}{\Delta  I_D} = \frac{ 1 \ \text{V}}{414.926 \ \text{nA}} = 2.401 \ \text{M}\Omega
\end{align}
...
\begin{align}
    r_{ds} = \frac{\Delta V_{DS}}{\Delta  I_D} = \frac{ 1 \ \text{V}}{20.776 \ \text{nA}} = 4.813 \ \text{M}\Omega
\end{align}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{plot_circuit_d_dc_sweep_Final.jpg}
    \caption{Screencapture of the DC sweep of circuits in figure \ref{fig:circuitd} and \ref{fig:circuitdsimple}.}
    \label{fig:plotd}
\end{figure}

The output resistance $r_{ds}$ is calculated in the same manner as for the previous circuits. For the circuit in figure \ref{fig:circuitd}:
\begin{align}
    r_{ds} = \frac{\Delta V_{DS}}{\Delta  I_D} = \frac{ 1 \ \text{V}}{349.466 \ \text{pA}} = 2861.51 \ \text{M}\Omega
\end{align}
