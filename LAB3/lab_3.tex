...
The next experiment is to tinker with the design parameter $\frac{W}{L}$ of $(M1)$  in order to improve the currenct source capability. For this rapport, the length $L$ was increased to $1 \  \mu m$ from the default $60 \ nm$. The DC sweep is then performed again, resulting in the following plot: 
